# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-04-27 06:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_type', models.CharField(choices=[('email', '邮件'), ('sms', '短信'), ('weixin', '微信'), ('script', '脚本')], max_length=64, verbose_name='动作类型')),
                ...
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('user_profiles', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL, verbose_name='所属用户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_type', models.IntegerField(choices=[(0, '报警事件'), (1, '维护事件')], verbose_name='事件类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hostname', models.CharField(help_text='agent方式要与cmdb客户端配置文件中hostname一致，snmp输入管理IP', max_length=64, unique=True, verbose_name='主机名称')),
                ...
                ('host_alive_check_interval', models.IntegerField(default=30, verbose_name='主机存活状态检测间隔(s)')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_unit', models.CharField(blank=True, max_length=64, null=True, verbose_name='数据单位')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specified_item_key', models.CharField(blank=True, max_length=64, null=True, verbose_name='只监控专门指定的指标key')),
                ...
                ('data_calc_func', models.CharField(choices=[('avg', '平均值'), ('max', '最大值'), ('min', '最小值'), ('hit', 'HIT'), ('last', '最近的值')], max_length=64, verbose_name='数据运算函数')),
                ('data_calc_func_args', models.CharField(blank=True, help_text='如：{"time": 5}，表示5分钟', max_length=64, null=True, verbose_name='数据运算函数的非固定参数,json格式')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.AddField(
            model_name='eventlog',
            name='hosts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor_data.Host', verbose_name='所属主机'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='triggers',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monitor_data.Trigger', verbose_name='所属触发器'),
        ),
        migrations.AddField(
